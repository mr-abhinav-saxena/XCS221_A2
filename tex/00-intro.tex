...
There are two city maps that you'll be working with: a grid map (|createGridMap|) and a map of Stanford (|createStanfordMap|), which is derived from \href{https://www.openstreetmap.org/}{Open Street Maps}. Please note that you do not need to know the Stanford campus in order to answer the questions below! We have also included instructions on how to create your own maps in |README.md|.

\textbf{Important: }On Windows some of the commands will lead to the python process not exiting and hanging. If you experience this behaviour, simply kill the process as the results will not be affected!